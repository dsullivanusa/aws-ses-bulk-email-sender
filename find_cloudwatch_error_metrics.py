...
def find_error_metrics_in_logs(log_group_name, hours_back=24, region='us-gov-west-1'):
    ...
    print(f"🕐 Searching from {start_time.strftime('%Y-%m-%d %H:%M:%S')} to {end_time.strftime('%Y-%m-%d %H:%M:%S')}")
    print()
...
def main():
    ...
    parser.add_argument('--log-group', required=True, help='CloudWatch log group name (e.g., /aws/lambda/email-worker)')
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        print("python find_cloudwatch_error_metrics.py --log-group /aws/lambda/email-worker")
        print("python find_cloudwatch_error_metrics.py --log-group /aws/lambda/email-worker --hours 6")
        print("python find_cloudwatch_error_metrics.py --log-group /aws/lambda/email-worker --save")
        print("python find_cloudwatch_error_metrics.py --log-group /aws/lambda/email-worker --region us-east-1")
        print()
