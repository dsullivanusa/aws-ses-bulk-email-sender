#!/usr/bin/env python3
"""
Fix All F-String Errors
This script fixes all f-string syntax errors in the Lambda function
"""
...
def fix_all_fstring_errors():
    ...
    print("Fixing all f-string syntax errors...")
    ...
    try:
        ...
        # Create backup
        with open('bulk_email_api_lambda.py.backup2', 'w', encoding='utf-8') as f:
            f.write(content)
        print("Created backup: bulk_email_api_lambda.py.backup2")
...
if __name__ == '__main__':
    success = fix_all_fstring_errors()
    if success:
        verify_fix()
