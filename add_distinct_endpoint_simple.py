#!/usr/bin/env python3
"""
Add /contacts/distinct endpoint to API Gateway - SIMPLE VERSION
EDIT THE LAMBDA_FUNCTION_NAME BELOW
"""
import boto3
import json

# ============================================
# EDIT THIS LINE WITH YOUR LAMBDA FUNCTION NAME:
# ============================================
LAMBDA_FUNCTION_NAME = 'bulk-email-api-function'  # <-- CHANGE THIS TO YOUR ACTUAL FUNCTION NAME
# ============================================
...
def add_distinct_endpoint():
    ...
    try:
        ...
        try:
            ...
            print(f"Error: {str(e)}")
            print("\nPlease edit this script and set the correct LAMBDA_FUNCTION_NAME at the top.")
            return
